...
export async function createMultiSendTransaction(ethersProvider: Ethers, safeAddress: string, privateKey: string, transactions: string[], isSafeMock = false) {
    const chainId = (await ethersProvider.provider.getNetwork()).chainId;
