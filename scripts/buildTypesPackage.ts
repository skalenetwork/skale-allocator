...
const PACKAGE_JSON_TEMPLATE = {
    name: "@skalenetwork/skale-allocator-types",
    version: "__VERSION__",
    description: "TypeScript typings for SKALE Allocator smart contracts",
    repository: {
        type: "git",
        url: "https://github.com/skalenetwork/skale-allocator.git"
    },
    keywords: [
       "skale",
       "skale-allocator",
    ...
    license: "AGPL-3.0",
    bugs: {
        url: "https://github.com/skalenetwork/skale-allocator/issues"
    },
    homepage: "https://github.com/skalenetwork/skale-allocator#readme",
    files: [
        "ethers-v5/**/*",
        "ethers-v6/**/*",
        "viem/**/*",
...
const README_CONTENT = `# @skalenetwork/skale-allocator-types

TypeScript type definitions for SKALE Allocator smart contracts.

This package provides TypeChain-generated typings for three popular Ethereum libraries:
- **ethers v5** - via \`@skalenetwork/skale-allocator-types/ethers-v5\`
- **ethers v6** - via \`@skalenetwork/skale-allocator-types/ethers-v6\`
- **viem** - via \`@skalenetwork/skale-allocator-types/viem\`
- **Raw ABIs** - via \`@skalenetwork/skale-allocator-types/abi/*\`
...
For usage examples, contract documentation, and more details, see the [SKALE Allocator repository](https://github.com/skalenetwork/skale-allocator).
    ...
    function extractABIsFromDirectory(dir: string) {
        ...
        for (const entry of entries) {
            ...
            if (entry.isDirectory()) {
                ...
                const artifactContent = JSON.parse(fs.readFileSync(fullPath, "utf-8")) as {
                    abi?: unknown[];
                    contractName?: string;
                };
...
function generateViemTypes() {
    ...
    if (abiFiles.length === 0) {
        console.error("⚠ No ABI files found while generating viem consts.");
        return;
    }
    ...
    for (const abiFile of abiFiles) {
        ...
        const abi = JSON.parse(fs.readFileSync(abiPath, "utf-8")) as JSON;
...
function main() {
    console.log("========================================");
    console.log("Building @skalenetwork/skale-allocator-types");
    console.log("========================================\n");
